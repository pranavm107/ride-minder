...
import TripUpdates from '@/components/student/TripUpdates';
import RewardsSection from '@/components/student/RewardsSection';
...
const StudentDashboard = () => {
  ...
  const handleBalanceAdjust = (amount: number) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
      ...
      <main className="container mx-auto px-4 py-6 pt-20">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-green-700">Tracking Bus #{currentBusStatus.busNumber}</span>
              </div>
            </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{studentInfo.class}</p>
                <p className="text-xs text-gray-500">{studentInfo.registerNo}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Assigned Route</p>
                <p className="font-semibold text-gray-900">{studentInfo.route}</p>
                <p className="text-xs text-gray-500">Stop: {studentInfo.stopName}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6 border-green-200">
          ...
          <CardContent>
            ...
            <div className="h-[300px] rounded-lg overflow-hidden">
              <MapView userType="student" mode="preview" height="100%" />
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          >
            <Bus size={24} />
            <span className="text-sm">Available Rides</span>
          </Button>
          ...
          <Button
            ...
            className="h-20 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 flex flex-col items-center justify-center gap-2"
          >
            <HelpCircle size={24} />
              ...
              {notifications.slice(0, 5).map((notification) => (
                ...
                >
                  <div className={cn(
                    ...
                    {notification.type === 'departure' && <Bus size={16} />}
      ...
      <Dialog open={showPayment} onOpenChange={setShowPayment}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Top up your wallet to pay for rides
            </DialogDescription>
          </DialogHeader>
          <PaymentForm onSuccess={handlePaymentSuccess} onClose={() => setShowPayment(false)} />
        </DialogContent>
      </Dialog>
    </div>
  );

...
CREATE POLICY "Admins can insert cabs" ON public.cabs
  FOR INSERT WITH CHECK (public.get_current_user_role() = 'admin');

CREATE POLICY "Admins can update cabs" ON public.cabs
  FOR UPDATE USING (public.get_current_user_role() = 'admin');

CREATE POLICY "Admins can delete cabs" ON public.cabs
  FOR DELETE USING (public.get_current_user_role() = 'admin');
...
CREATE POLICY "Drivers can insert attendance for their cab" ON public.attendance
...
CREATE POLICY "Drivers can update attendance for their cab" ON public.attendance
  FOR UPDATE USING (
    cab_id IN (
      SELECT cab_id FROM public.drivers WHERE user_id = (SELECT id FROM public.profiles WHERE user_id = auth.uid())
    )
...
CREATE POLICY "Drivers can insert their cab location" ON public.live_locations
  FOR INSERT WITH CHECK (
    cab_id IN (
      SELECT cab_id FROM public.drivers WHERE user_id = (SELECT id FROM public.profiles WHERE user_id = auth.uid())
    )
...
CREATE POLICY "Admins can insert live locations" ON public.live_locations
  FOR INSERT WITH CHECK (public.get_current_user_role() = 'admin');

CREATE POLICY "Admins can update live locations" ON public.live_locations
  FOR UPDATE USING (public.get_current_user_role() = 'admin');

CREATE POLICY "Admins can delete live locations" ON public.live_locations
  FOR DELETE USING (public.get_current_user_role() = 'admin');
...
CREATE POLICY "Admins can update SOS alerts" ON public.sos_alerts
  FOR UPDATE USING (public.get_current_user_role() = 'admin');

CREATE POLICY "Admins can delete SOS alerts" ON public.sos_alerts
  FOR DELETE USING (public.get_current_user_role() = 'admin');
...
CREATE POLICY "Admins can insert camera events" ON public.camera_events
  FOR INSERT WITH CHECK (public.get_current_user_role() = 'admin');

CREATE POLICY "Admins can update camera events" ON public.camera_events
  FOR UPDATE USING (public.get_current_user_role() = 'admin');

CREATE POLICY "Admins can delete camera events" ON public.camera_events
  FOR DELETE USING (public.get_current_user_role() = 'admin');
...
CREATE POLICY "Admins can update guest bookings" ON public.guest_bookings
  FOR UPDATE USING (public.get_current_user_role() = 'admin');

CREATE POLICY "Admins can delete guest bookings" ON public.guest_bookings
  FOR DELETE USING (public.get_current_user_role() = 'admin');
